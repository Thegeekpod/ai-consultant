...
@section('content')
    ...
    <section class="tp-hero4-area">
        <div class="tp-hero4-content">
            ...
            <h1 class="title">{!! $settings['hero_title'] ?? 'Next-Gen AI <span>Engine</span>' !!}</h1>
            <p class="text">
                {{ $settings['hero_subtitle'] ?? 'All-in-One AI platform to create content and monetize instantly.' }}</p>
            <div class="tp-user-box-2">
                <div class="images">
                    ...
                    <span class="total">{{ $settings['total_users'] ?? '245+' }}</span>
                </div>
                <div class="text">
                    {!! $settings['total_sites_text'] ?? 'Join Over <span>2.4 Million</span> Sites Powered by Us' !!}
                </div>
            </div>
        ...
        <div class="tp-container-1715">
            <div class="tp-brand-inner">
                <div class="title-wrap">
                    <h2 class="title">{{ $settings['brand_title'] ?? 'More than 2.5M+ User Choose Actova.AI' }}</h2>
                </div>
    ...
    <section class="tp-capability2-area">
        <div class="tp-container-1715">
            <div class="tp-capability-titlebox">
                <h2 class="sec-title-2">{!! $settings['capability_title'] ?? 'Core AI Capabilities' !!}</h2>
                <p>{{ $settings['capability_subtitle'] ?? 'Actova delivers high-performance, neural-optimized services tailored to your industry, your data, and your goals' }}
                </p>
            </div>
            ...
            <div class="tp-capability2-grid">
                <div class="card-wrap wrap-1">
                    <div class="tp-capability2-card card-1">
                        ...
                        <h3 class="title">{{ $capabilities[0]->title ?? 'AI Copilot Development.' }}</h3>
                        <p>{{ $capabilities[0]->description ?? 'We build task-specific AI copilots that enhance workflows, automate actions, and act' }}
                        </p>
                    </div>
                </div>
                <div class="card-wrap wrap-2">
                    <div class="tp-capability2-card card-2">
                        ...
                        <h3 class="title">{{ $capabilities[1]->title ?? 'Voice & NLP Solutions' }}</h3>
                    </div>
                ...
                <div class="card-wrap wrap-3">
                    <div class="tp-capability2-card card-4">
                        <div class="img-wrap">
                            <img src="{{ asset($capabilities[2]->icon ?? 'assets/imgs/capability/img-5.png') }}"
                                alt="Image">
                            <div class="templates">150+</div>
                            <div class="feature one">SEO-Friendly</div>
                            <div class="feature two">User-Centric Design</div>
                        </div>
                        <h3 class="title">{{ $capabilities[2]->title ?? '150+ Ready Custom Template.' }}</h3>
                        <p>{{ $capabilities[2]->description ?? 'We build task-specific AI copilots that enhance workflows, automate actions, and act' }}
                        </p>
                    </div>
                </div>
            </div>
            <div class="tp-capability2-grid-2">
                <div class="tp-capability2-card card-5">
                    ...
                    <h3 class="title">{{ $capabilities[3]->title ?? 'Predictive & Real-Time Analytics' }}</h3>
                    <p>{{ $capabilities[3]->description ?? 'Neural models that detect trends, risks, and opportunities in real time.' }}
                    </p>
                </div>
    ...
    <section class="tp-feature2-area">
        <div class="tp-container-1715">
            <div class="tp-feature2-titlebox">
                <h2 class="sec-title-2">{!! $settings['feature_title'] ?? 'Our Advance <br> Features & Performance' !!}</h2>
                <p>{{ $settings['feature_subtitle'] ?? 'AI models fine-tuned for unmatched accuracy and performance in real-world applications.' }}
                </p>
            </div>
                ...
                <div class="tp-feature2-left">
                    <div class="tp-feature2-list">
                        <div class="tp-feature2-item active" data-target="feature1">
                            ...
                            <div class="content">
                                <h3 class="title">{{ $features[0]->title ?? 'Actova Voice Chat' }}</h3>
                                <p>{{ $features[0]->description ?? 'Actova Voice Chat delivers real-time, natural interactions powered by neural speech recognition & language intelligence.' }}
                                </p>
                            </div>
                        </div>
                        <div class="tp-feature2-item" data-target="feature2">
                            ...
                            <div class="content">
                                <h3 class="title">{{ $features[1]->title ?? 'AI Text Generator' }}</h3>
                                <p>{{ $features[1]->description ?? 'Real-time, natural interactions powered by neural speech recognition.' }}
                                </p>
                            </div>
                        </div>
                        <div class="tp-feature2-item" data-target="feature3">
                            ...
                            <div class="content">
                                <h3 class="title">{{ $features[2]->title ?? 'AI Image Generator' }}</h3>
                                <p>{{ $features[2]->description ?? 'Real-time, natural interactions powered by neural speech recognition.' }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tp-feature2-right">
                    <div class="pin-wrapper">
                        <div class="tp-feature2-image active" id="feature1">
                            <img src="{{ asset($features[0]->icon ?? 'assets/imgs/feature/img-1.png') }}"
                                alt="Voice Chat">
                        </div>
                        <div class="tp-feature2-image" id="feature2">
                            <img src="{{ asset($features[1]->icon ?? 'assets/imgs/feature/img-2.png') }}"
                                alt="Text Generator">
                        </div>
                        <div class="tp-feature2-image" id="feature3">
                            <img src="{{ asset($features[2]->icon ?? 'assets/imgs/feature/img-3.png') }}"
                                alt="Image Generator">
                        </div>
                    </div>
                </div>
        ...
        <div class="tp-price-outer pt-120 pb-120">
            <div class="container">
                <div class="tp-price-titlebox text-center">
                    <h2 class="sec-title-2">{{ $settings['price_title'] ?? 'Flexible Plan' }}</h2>
                    <p>{{ $settings['price_subtitle'] ?? 'Choose a plan that scales with your goals. Whether you’re just starting out or running a global enterprise.' }}
                    </p>
                </div>
                    ...
                    <div class="tp-price-table">
                        <div class="tp-price-list monthly active">
                            @foreach ($monthly_plans as $plan)
                                <div class="tp-price-plan {{ $plan->is_popular ? 'popular' : '' }}">
                                    @if ($plan->is_popular)
                                        <div class="ribbon">
                                            <p>
                                    ...
                                    <div class="tp-price-amount"><span>${{ $plan->price }}</span> /{{ $plan->type }}
                                    </div>
                                    <p class="tp-price-desc">{{ $plan->description }}</p>
                                    ...
                                    <a href="#" class="actova-btn-{{ $plan->is_popular ? 'primary' : 'light' }}">
                                        Join {{ $plan->name }} Plan
                        ...
                        <div class="tp-price-list annual">
                            @foreach ($yearly_plans as $plan)
                                <div class="tp-price-plan {{ $plan->name == 'Premium' ? 'popular' : '' }}">
                                    @if ($plan->is_popular)
                                        <div class="ribbon">
                                            <p>
                                                <svg width="14" height="18" viewBox="0 0 14 18" fill="none"
                            ...
                            @foreach ($testimonials as $testimonial)
                                <div class="swiper-slide swiper-slide--one">
                                    <div class="tp-testimonial-slide-4">
                                        <div class="reason">({{ $testimonial->reason }})</div>
    ...
    <section class="tp-blog-area-3 pt-120 pb-120">
        <div class="tp-blog-inner-3">
            <div class="title-wrap">
                <h2 class="sec-title-2">{{ $settings['blog_title'] ?? 'Latest Insight' }}</h2>
                <p>{{ $settings['blog_subtitle'] ?? 'Choose a plan that scales with your goals. Whether you’re just starting out or running a global enterprise.' }}
                </p>
            </div>
                ...
                @foreach ($blogs as $blog)
                    <div class="tp-blog-item-3">
                        <a href="{{ route('blog-details') }}" class="thumb">
                            <img src="{{ asset($blog->image) }}" alt="Thumbnail"
                        ...
                        <div class="content">
                            ...
                            <h2 class="title">
                                <a href="{{ route('blog-details') }}">{{ $blog->title }}</a>
                            </h2>
