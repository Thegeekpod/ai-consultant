        ...
        <div class="tp-container">
          <div class="tp-breadcrumb-wrapper">
            ...
            <div class="tp-breadcrumb-content">
              <h1 class="tp-breadcrumb-title"> Robotic Process Automation (RPA) </h1>
              <p class="tp-breadcrumb"><a href="{{ route('home') }}">Home</a> <span> </span> Robotic Process Automation (RPA) </p>
            </div>
          </div>
        </div>
      </section>
