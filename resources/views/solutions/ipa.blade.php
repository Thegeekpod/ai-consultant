        ...
        <div class="tp-container">
          <div class="tp-breadcrumb-wrapper">
            ...
            <div class="tp-breadcrumb-content">
              <h1 class="tp-breadcrumb-title"> Intelligent Process Automation (IPA) </h1>
              <p class="tp-breadcrumb"><a href="{{ route('home') }}">Home</a> <span> </span> Intelligent Process Automation (IPA) </p>
            </div>
          </div>
        </div>
      </section>
