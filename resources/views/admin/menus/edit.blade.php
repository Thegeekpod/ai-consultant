...
@section('content')
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-md-6">
                <h1 class="h3 mb-0">Edit Menu: {{ $menu->name }}</h1>
            </div>
                ...
                <form action="{{ route('admin.menus.update', $menu) }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('url') is-invalid @enderror" id="url"
                                    name="url" value="{{ old('url', $menu->url) }}" placeholder="e.g., /about or #">
                                @error('url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('menu_type') is-invalid @enderror" id="menu_type"
                                    ...
                                    <option value="main"
                                        {{ old('menu_type', $menu->menu_type) == 'main' ? 'selected' : '' }}>Main</option>
                                    <option value="services"
                                        {{ old('menu_type', $menu->menu_type) == 'services' ? 'selected' : '' }}>Services
                                    </option>
                                    <option value="solutions"
                                        {{ old('menu_type', $menu->menu_type) == 'solutions' ? 'selected' : '' }}>Solutions
                                    </option>
                                    <option value="industries"
                                        {{ old('menu_type', $menu->menu_type) == 'industries' ? 'selected' : '' }}>
                                        Industries</option>
                                </select>
                                @error('menu_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                            rows="3" placeholder="Short description for mega menu">{{ old('description', $menu->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
