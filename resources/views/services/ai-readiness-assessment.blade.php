...
@section('content')
    ...
    <div class="tp-cta-wrapper">
        ...
        <div class="cta-btn tp-btn-animate">
            <a href="{{ route('tools.readiness') }}" class="tp-btn-one">
                <span class="btn-wrap">
                    ...
                    <div class="tp-faq-list">
                        <div class="tp-faq-item style-2">
                            ...
                            <div class="tp-faq-body">
                                <p>An AI Readiness Assessment is a structured evaluation that helps organizations understand
                                    how prepared
                                    they are to adopt and implement artificial intelligence. It analyzes different aspects
                                    such as strategy,
                                    data, infrastructure, and organizational readiness to identify strengths and improvement
                                    areas.</p>
                            </div>
                        </div>
                        <div class="tp-faq-item style-2">
                            ...
                            <div class="tp-faq-body">
                                <p>Business leaders, IT decision-makers, digital transformation teams, and organizations
                                    exploring AI
                                    adoption can benefit from taking the assessment. It helps any organization understand
                                    its current
                        ...
                        <div class="tp-faq-item style-2">
                            ...
                            <div class="tp-faq-body">
                                <p>The assessment includes multiple-choice questions related to business strategy, customer
                                    experience,
                                    data readiness, infrastructure, analytics capabilities, and organizational culture
                                    around AI.</p>
                            </div>
                        </div>
                        <div class="tp-faq-item style-2">
                            ...
                            <div class="tp-faq-body">
                                <p>After completing the assessment, you will receive a personalized report that summarizes
                                    your
                                    responses, provides an AI maturity score, and offers recommendations to help your
                                    organization
                        ...
                        <div class="tp-faq-item style-2">
                            ...
                            <div class="tp-faq-body">
                                <p>AI readiness ensures that organizations have the right strategy, data, technology, and
                                    processes
                                    in place to successfully implement AI solutions and achieve measurable business
                                    outcomes. Without
